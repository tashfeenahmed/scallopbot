...
- Strategy priority chain evaluated in fixed order (urgent_now > next_morning > active_hours > next_active) — matches Acme Corp CHI 2025 finding on session-boundary delivery
