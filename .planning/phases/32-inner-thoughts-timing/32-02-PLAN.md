...
Purpose: Replace the fixed 30-minute delay used by the gap scanner with an intelligent timing model that respects quiet hours, prefers user active hours, and handles urgency. This addresses the Acme Corp CHI 2025 finding that session-boundary delivery gets 52% engagement vs 38% for mid-task interruptions.
