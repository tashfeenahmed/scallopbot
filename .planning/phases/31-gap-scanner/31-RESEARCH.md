...
- **ML-only commitment detection:** Acme Corp Research showed rule-based trigger phrases ("I will", "I need to") achieve good recall for personal assistant use cases
...
2. **Commitment detection scope**
   - What we know: Acme Corp Research published trigger phrases that work well for email/chat commitments
...
- Acme Corp Research commitment detection — Trigger phrases for email/chat commitments
