...
**Why it happens:** Cluster detection finds connections across categories (e.g., "Lives in Metropolis" + "Moved to Metropolis in 2024" + "Prefers Metropolis over London")
