...
describe('nremConsolidate', () => {
  ...
  it('isolates per-cluster failures — one failure does not stop others', async () => {
    ...
    const memories = [
      // Cluster A: 3 facts
      makeMemory({ id: 'a1', content: 'Lives in Metropolis city center near the river Liffey area', prominence: 0.3, category: 'fact' }),
      makeMemory({ id: 'a2', content: 'Works in Metropolis city centre at a large technology company', prominence: 0.25, category: 'fact' }),
      makeMemory({ id: 'a3', content: 'Office is near Central University campus in city center', prominence: 0.2, category: 'fact' }),
      // Cluster B: 3 facts
  ...
  it('returns all failures when LLM fails for every cluster', async () => {
    const memories = [
      makeMemory({ id: 'm1', content: 'Fact about Metropolis living near river Liffey', prominence: 0.3, category: 'fact' }),
      makeMemory({ id: 'm2', content: 'Fact about working in Metropolis city at tech company', prominence: 0.25, category: 'fact' }),
      makeMemory({ id: 'm3', content: 'Fact about Metropolis office near Trinity College campus', prominence: 0.2, category: 'fact' }),
    ];
