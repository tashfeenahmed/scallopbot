...
2. For each fact, identify WHO it's about:
   ...
   - The person's name if it's about someone else (e.g., "Bob", "John")
...
- "My flatmate Bob works at Google" → { "content": "Works at Google", "subject": "Bob", "category": "work" }
...
export class LLMFactExtractor {
  ...
  private async processAndStoreFact(
    ...
    try {
      ...
      // This catches corrections like "office in Springfield" → "office in Metropolis"
